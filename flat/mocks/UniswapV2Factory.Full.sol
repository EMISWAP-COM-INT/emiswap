...
// File: contracts/uniswapv2/libraries/SafeMathUni.sol
...
// File: contracts/uniswapv2/interfaces/IERC20Uni.sol
...
contract UniswapV2Pair is UniswapV2ERC20 {
    ...
    function skim(address to) external lock {
        ...
        _safeTransfer(
            _token0,
            to,
            IERC20Uni(_token0).balanceOf(address(this)).sub(reserve0)
        );
        _safeTransfer(
            _token1,
            to,
            IERC20Uni(_token1).balanceOf(address(this)).sub(reserve1)
        );
    }
